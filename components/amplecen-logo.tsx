  ...
  return (
    <Link href="/" className="flex items-center gap-3 group">
      ...
      <div className="flex flex-col -space-y-1">
        <span className={`
          ${sizeClasses[size]} font-display font-light tracking-tight 
          text-warm-white transition-colors duration-300
          group-hover:text-ember-bright
        `}>
          Amplecen
        </span>
        <span className="text-[10px] font-sans font-bold uppercase text-haze/60 group-hover:text-haze transition-colors">
          ID
        </span>
      </div>
    </Link>
